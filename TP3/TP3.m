...
audio_files = dir('C:\Users\tomig\Downloads\ProcesosEstocasticos\TP3\Audios\*.wav'); %tomo todos los audios de la carpeta Audios
...
function Ej_4_A(a, G, Fs, n_fft)
    ...
    for i = 1:num_fonemas
        ...
        hold on;
        plot(f_est, 20*log10(S_estimada), '--', 'LineWidth', 1.2, 'DisplayName', 'Sintetizada');
        xlabel('Frecuencia [Hz]');
        ylabel('Amplitud [dB]');
